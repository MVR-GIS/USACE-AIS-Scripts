...
# Get token 
pull_token <- function() {
  requestTokenURL <- "https://imsoidc.bentley.com/connect/token"
  clientID <- ""
  clientSecret <- ""
  sandInstID <- "57ab7d21-5ff3-49fc-8dfd-fa41e75121da"
  usaceInstID <- "570c1f2b-aed1-4791-a20b-4b8ac8cdd2c8"
